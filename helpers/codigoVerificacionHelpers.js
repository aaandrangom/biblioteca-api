...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hola,</p>
            <p>El pedido con el identificador <strong>{{ped_secuencial}}</strong> ha sido cancelado por el usuario.</p>
            <p>Si tienes alguna pregunta, no dudes en contactarnos.</p>
        </div>
        <div class="footer">
            <p>Saludos,</p>
...
async function enviarMensajeLibroCancelado(pedSecuencial, usuarioEmail) {
  const htmlLibroCanceladof = htmlLibroCancelado.replace(
    "{{ped_secuencial}}",
    pedSecuencial
  );
